...
// {
//   Mesh* m = 0;
//   g_rm.getResource("square", (void**)&m);
//   unsigned int t = 0;
//   g_rm.getResource("title card", t);
//   if (m && t)
//   {
...
//     // ImGuizmo::DrawCubes(glm::value_ptr( cameraView ), glm::value_ptr(  cameraProjection ), glm::value_ptr( objectMatrix ), 1);

//     // ImGui::End();
    
//     // ImGuizmo::SetRect(0, 0, io.DisplaySize.x, io.DisplaySize.y);
//     // ImGuizmo::ViewManipulate(glm::value_ptr( cameraView ), 15.0, ImVec2(io.DisplaySize.x - 128, 0), ImVec2(128, 128), 0x10101010);
